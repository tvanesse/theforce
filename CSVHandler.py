...
class Field(CSVFile):
	...
	"""
	def __init__(self, header=None, values=list()) :
		self._title = header
		self._data = values
...
if __name__ == "__main__":
	...
	if os.path.isfile(sys.argv[1]):
		...
		test_field = 8
		print("This is field {} : {}".format(c.headers[test_field], c.data[c.headers[test_field]]))
		print("Size : {}".format(len(c.data[c.headers[test_field]])))
	else:
